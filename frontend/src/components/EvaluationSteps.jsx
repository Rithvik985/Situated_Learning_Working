...
const EvaluationSteps = ({ 
  ...
  if (currentStep === 3 && selectedAssignment) {
    // This Step 3 is now handled in the main Evaluation.jsx component
    // to support both existing rubric display/edit and new rubric generation
    return null
  }

  if (currentStep === 4 && selectedRubric) {
    return (
      <div className="card">
